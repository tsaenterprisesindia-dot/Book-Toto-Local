    ...
    <div className="auth-page">
      <div className="card auth-card fade-in">
        ...
        <div className="card mt" style={{ background: 'var(--bg)', boxShadow: 'none' }}>
          ...
          <div className="row">
            <button className="btn btn-ghost small" onClick={() => quick('rider@booktoto.local')}>
              Rider
            </button>
            <button className="btn btn-ghost small" onClick={() => quick('driver@booktoto.local')}>
              Driver
            </button>
            <button className="btn btn-ghost small" onClick={() => quick('admin@booktoto.local')}>
              Admin
            </button>
          </div>
        </div>
